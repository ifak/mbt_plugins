...
#include "ui_statemachineeditorotherstatesettings.h"
...
class StateMachineEditorOtherstateSettingsWidget
        : public QWidget
{
    Q_OBJECT

public:
    explicit StateMachineEditorOtherstateSettingsWidget(QWidget *parent = 0);
    ~StateMachineEditorOtherstateSettingsWidget();
...
class StateMachineEditorOtherstateSettingsPage
...
private:
    ...
    Ui::StateMachineEditorOtherStateSettings _ui;
    QString _searchKeywords;
    QPointer<StateMachineEditorOtherstateSettingsWidget> _widget;
