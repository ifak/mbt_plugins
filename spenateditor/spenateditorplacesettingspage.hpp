...
#include "ui_spenateditorplacesettings.h"
...
class SpenatEditorPlaceSettingsWidget
        : public QWidget
{
    Q_OBJECT

public:
    explicit SpenatEditorPlaceSettingsWidget(QWidget *parent = 0);
    ~SpenatEditorPlaceSettingsWidget();
...
class SpenatEditorPlaceSettingsPage
...
private:
    ...
    Ui::SpenatEditorPlaceSettings _ui;
    QString _searchKeywords;
    QPointer<SpenatEditorPlaceSettingsWidget> _widget;
