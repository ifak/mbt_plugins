...
#include "ui_spenateditorarcsettings.h"
...
class SpenatEditorArcSettingsWidget
        : public QWidget
{
    Q_OBJECT

public:
    explicit SpenatEditorArcSettingsWidget(QWidget *parent = 0);
    ~SpenatEditorArcSettingsWidget();
...
class SpenatEditorArcSettingsPage
...
private:
    ...
    Ui::SpenatEditorArcSettings _ui;
    QString _searchKeywords;
    QPointer<SpenatEditorArcSettingsWidget> _widget;
