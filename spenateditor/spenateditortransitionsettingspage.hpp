...
#include "ui_spenateditortransitionsettings.h"
...
class SpenatEditorTransitionSettingsWidget
        : public QWidget
{
    Q_OBJECT

public:
    explicit SpenatEditorTransitionSettingsWidget(QWidget *parent = 0);
    ~SpenatEditorTransitionSettingsWidget();
...
class SpenatEditorTransitionSettingsPage
...
private:
    ...
    Ui::SpenatEditorTransitionSettings _ui;
    QString _searchKeywords;
    QPointer<SpenatEditorTransitionSettingsWidget> _widget;
