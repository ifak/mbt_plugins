...
class SimSystemEditor;

namespace Internal{

class SimSystemEditorOutlineTreeView
    : public Utils::NavigationTreeView
{
  Q_OBJECT

public:
  SimSystemEditorOutlineTreeView(QWidget *parent);
...
class SimSystemEditorOutlineWidget
    : public TextEditor::IOutlineWidget
{
  Q_OBJECT
public:
  SimSystemEditorOutlineWidget(SimSystemEditor* SimSystemEditor);
...
private:
  Q_DISABLE_COPY(SimSystemEditorOutlineWidget)
  class Private;
  Private* _d;
};

class SimSystemEditorOutlineWidgetFactory
