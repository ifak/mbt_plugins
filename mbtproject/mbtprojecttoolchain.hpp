...
class MBTPROJECTSHARED_EXPORT MbtProjectToolChain
    : public ProjectExplorer::BaseProjectToolChain
{
public:
  MbtProjectToolChain();
  MbtProjectToolChain(bool autodetect);
  virtual ~MbtProjectToolChain();
};

class MBTPROJECTSHARED_EXPORT MbtProjectToolChainFactory
...
public:
  ...
  virtual ~MbtProjectToolChainFactory();

public:/// relevant virtual implementations
  MbtProjectToolChain* create();
  MbtProjectToolChain* restore(const QVariantMap& data);
};
